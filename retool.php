...
$BASEURL = "https://www.resetera.com/threads";
$PSTURL = "https://www.resetera.com/posts";
$STARTPOST = "<li id="post-";
$ENDPOST = "</li";
$STARTHIGHLIGHT = "<span style=\"COLOR: #ff0000\">";
$ENDHIGHLIGHT = "</span>";
$VOTECOMMAND = "vote";
...
$DAYSTART = "begins";
$DAYEND = "ends";
$PRESTARTPOSTER = "data-author";
$STARTPOSTER = ">";
$ENDPOSTER = ">";
$STARTQUOTE = "<blockquote";
$STARTMETA = "<div class=\"messageMeta";
$ENDMETA = "</div>";
$STARTPOSTNR = "><b>";
$ENDPOSTNR = "</b>";
...
$ENDLINK = "\" name";
$ENDQUOTE = "</blockquote>";
$STARTPAGES = "<span class=\"pagenavheader\"";
$ENDPAGES = "</span>";
$PAGES1 = "page";
$PAGES2 = "of";
...
{
	return ("https://www.resetera.com/posts/".$p."#post".$p);
}
...
{
	$URL = $BASEURL."/".$TOPICNR."/page-".$currentPage;
